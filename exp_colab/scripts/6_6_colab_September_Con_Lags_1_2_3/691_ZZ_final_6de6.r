...
PARAM  <- list()
PARAM$experimento  <- "ZZ6910-septiembre-2021-con-lags-1-2-3"
PARAM$exp_input  <- "HT6510-septiembre-2021-con-lags-1-2-3"
...
PARAM$semillas  <- c( 123457, 123401, 123407, 999959, 999961 ) #reemplazar por las propias semillas
