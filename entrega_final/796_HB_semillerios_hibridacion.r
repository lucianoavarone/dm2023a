...
PARAM  <- list()
PARAM$experimento  <- "HB7960_def_202109"

PARAM$exp_input  <- c( "ZZ7950_default_1_202109", "ZZ7950_default_2_202109", "ZZ7950_default_3_202109")  # el inpput deben ser semillerios
